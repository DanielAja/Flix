...
class MoviesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var movies=[[String:Any]]() // Create dictionary
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let disc = movie["overview"]as! String
        cell.movieTitle!.text = movieTitle
        cell.movieDisc!.text = disc
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let currentMovie = movies[index.row]
        
        let currentDetailsVC = segue.destination as! MovieDetailsViewController
        currentDetailsVC.movie = currentMovie
